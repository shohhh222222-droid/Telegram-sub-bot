...
# ====== TEST UCHUN TOKEN VA ADMIN ======
API_TOKEN = "8421096608:AAG-o2z5FIR_HLjnjiQAvk8fHZ4saL1NL_I"
ADMIN_ID = 7925556738
# =====================================

# 2 TA KANAL (bot admin bo‘lishi kerak)
...
# --- Tarjima + ovoz ---
@dp.callback_query_handler(lambda c: c.data in ["en", "ru", "uz"])
async def translate_voice(call: types.CallbackQuery):
